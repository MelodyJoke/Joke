package com.melody.base.template.fragment;
...
public abstract class BaseFragment extends Fragment {
    ...
    protected void setContentView(@LayoutRes int layoutRes, ViewGroup parent) {
        mLayoutView = LayoutInflater.from(mContext).inflate(layoutRes, parent, false);
    }
