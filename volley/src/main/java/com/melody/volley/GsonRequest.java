...
public class GsonRequest<T> extends Request<T> {
    ...
    public GsonRequest(String url, TypeToken<T> typeToken, Listener<T> listener,
                       ErrorListener errorListener) {
        this(Method.GET, null, url, typeToken, listener, errorListener);
    }

    public GsonRequest(int method, Map<String, String> params, String url, Class<T> clazz,
